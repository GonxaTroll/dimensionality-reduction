...
def main():
    ...
    print("SUMMARY")
    print("=" * 60)
    print(f"Total variance explained by 2 components: {sum(model.explained_variance_ratio_[:2]):.2%}")
    print(f"Total variance explained by all components: {sum(model.explained_variance_ratio_):.2%}")
